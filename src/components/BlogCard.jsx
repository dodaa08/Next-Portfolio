  ...
  return (
    <>
      <main className="flex justify-center py-6">
        <div className=" text-white flex flex-col py-3 px-6 rounded-xl shadow-md border-2 border-gray-700 font-mono transition-transform transform max-w-sm w-full">
