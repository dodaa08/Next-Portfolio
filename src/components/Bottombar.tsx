    ...
    return(
        <>   
         ...
         <div className="sm:flex md:flex md:flex-col space-y-5 md:space-y-1.5 mb-10 "> 
            ...
            <p className="text-xl font-sans">I keep my <span className="px-2 text-decoration-line: underline"> twitter</span> updated with all my active projects. Besides coding I like tinkering </p>
