...
function Landing() {
  return (
    <div className="flex justify-center items-center h-screen md:translate-y-[-10%]">
      <div className="container mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div className="mt-10 ">
          ...
          <div className="md:flex md:justify-center gap-6 mt-6 justify-items-center">
            <div className="md:flex-col space-y-4">
